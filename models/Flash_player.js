  ...
  window.addEventListener('message', function (m) {
    ...
    if (m.data.type === eventName) {
      if (m.data.data && m.data.data.id) {
        ...
        var playing = (c === 'PlayStarted' || (c !== 'PlayComplete' && c !== 'Paused' && c !== 'BufferEmpty' && c !== 'NetworkDropped' && c !== 'PlayInterrupted' && c !== 'IdleTimeout'))
          
        var paused = (c === 'Paused' || c === 'NetworkDropped' || c === 'PlayInterrupted' || c === 'IdleTimeout')
